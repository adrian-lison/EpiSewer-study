...
all_selection_targets[["SARSCoV_22-23_ARA_Werdhoelzli"]] <- list(
  ...
  tar_target(
    date_select,
    {
      ...
      to = c(
        seq.Date(as.Date("2022-10-01"), as.Date("2023-06-01"), by="1 day"),
        as.Date("2023-08-01")
      )
      mapply(
...
all_selection_targets[["IAV_22-23_ARA_Werdhoelzli"]] <- list(
  ...
  tar_target(
    date_select,
    {
      ...
      to = c(
        seq.Date(as.Date("2022-09-24"), as.Date("2023-07-24"), by="1 day"),
        as.Date("2023-08-01")
      )
      mapply(
        function(from, to) c(from = from, to = to), from = from, to = to, SIMPLIFY = FALSE
...
all_selection_targets[["RSV_22-23_ARA_Werdhoelzli"]] <- list(
  ...
  tar_target(
    date_select,
    {
      from = as.Date("2022-08-15")
      to = c(
        seq.Date(as.Date("2022-09-12"), as.Date("2023-06-12"), by="1 day"),
        as.Date("2023-08-01")
      )
      mapply(
        function(from, to) c(from = from, to = to), from = from, to = to, SIMPLIFY = FALSE
...
all_selection_targets[["RSV_22-23_CDA_Lugano"]] <- list(
  ...
  tar_target(
    date_select,
    {
      from = as.Date("2022-11-07") # first measurement
      to = c(
        seq.Date(as.Date("2022-11-28"), as.Date("2023-07-17"), by="1 day"),
        as.Date("2023-08-01")
      )
      mapply(
        function(from, to) c(from = from, to = to), from = from, to = to, SIMPLIFY = FALSE
...
all_selection_targets[["RSV_22-23_ARA_Chur"]] <- list(
  ...
  tar_target(
    date_select,
    {
      from = as.Date("2022-11-07") # first measurement
      to = c(
        seq.Date(as.Date("2022-11-28"), as.Date("2023-06-05"), by="1 day"),
        as.Date("2023-08-01")
      )
      mapply(
        function(from, to) c(from = from, to = to), from = from, to = to, SIMPLIFY = FALSE
